...
public interface IListener<T> {
	public void changed(T ref, IMonadex<? extends IReadOnlyMonad> context);

	public void added(T ref, IMonadex<? extends IReadOnlyMonad> context);

	public void removed(T ref, IMonadex<? extends IReadOnlyMonad> context);

	public void reverted(T ref, IMonadex<? extends IReadOnlyMonad> context);
}
