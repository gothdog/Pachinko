...
public interface IReadWriteMonadex<M extends IMonad<?>> extends IMonadex<M> {
  /**
   * Set the value of the variable within the current context named <name> to
   * the value <value>.
   */
  public void returnValue(String name, Object value);

  /**
   * Set the value of the variable within the current context found at offset
   * <index> to the value <value>.
   */
