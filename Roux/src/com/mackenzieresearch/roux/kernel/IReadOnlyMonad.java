...
public interface IReadOnlyMonad<T extends Object> extends IListenable {
  /**
   * Returns the value of the variable in the current context referenced by this context reference.
   */
  public T bindValue(IMonadex<? extends IReadOnlyMonad> context);

  /**
   * Returns the name of the variable in the current context referenced by this context reference.
   */
