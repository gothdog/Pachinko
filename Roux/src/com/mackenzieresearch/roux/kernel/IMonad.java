...
public interface IMonad<T> extends IReadOnlyMonad<T> {
  /**
   * Set the value of the variable in the current context referenced by this
   * context reference.

   */
  void returnValue(T value, IMonadex<? extends IMonad> context);

  /**
   * Set the value of the variable in the current context referenced by this
   * context reference.
   */
  void returnObject(Object value, IMonadex<? extends IMonad> context);
}
